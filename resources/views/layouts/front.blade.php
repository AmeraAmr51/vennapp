...
<head>
    ...
    <link href="{{ asset('css/front/edit.css') }}" type="text/css" rel="stylesheet">
...
<body class="common-front @if($currentLang->rtl == 1) rtl @endif" @if($currentLang->rtl == 1) dir="rtl" @endif>
    ...
    <div class="style-box">
        ...
        <div class="colors">
            <li class ="active" data-color = "#6164ff"></li>
            <li data-color = "#dc3545"></li>
            <li data-color = "#28a745"></li>
            <li data-color = "#17a2b8"></li>
        </div>
    </div>
    ...
    <script src="{{ asset('js/front/edit.js') }}" defer></script>
