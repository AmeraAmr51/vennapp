...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        @if(Auth::user()->role->name == 'administrator')
            <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="/admin" data-toggle="collapse" data-target="#collapseVideos"
                       aria-expanded="true" aria-controls="collapseVideos">
                        <i class="far fa-fw fa-file"></i>
                        <span>{{clean( trans('niva-backend.videos') , array('Attr.EnableID' => true))}}</span>
                    </a>
                    <div id="collapseVideos" class="collapse"  data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="{{ route('video.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_videos') , array('Attr.EnableID' => true))}}</a>
                            <a class="collapse-item" href="{{ route('video.create') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.create_video') , array('Attr.EnableID' => true))}}</a>
                        </div>
                    </div>
                </li>
            @endif
        ...
        @if(Auth::user()->role->name == 'administrator')
            <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="/admin" data-toggle="collapse" data-target="#collapseOrders"
                       aria-expanded="true" aria-controls="collapseOrders">
                        <i class="far fa-fw fa-file"></i>
                        <span>{{clean( trans('niva-backend.orders') , array('Attr.EnableID' => true))}}</span>
                    </a>
                    <div id="collapseOrders" class="collapse"  data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="{{ route('order.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_orders') , array('Attr.EnableID' => true))}}</a>
                        </div>
                    </div>
                </li>
            @endif
