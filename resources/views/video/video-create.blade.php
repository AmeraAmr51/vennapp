...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.create_video') , array('Attr.EnableID' => true))}}</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="{{route('video.index')  . '?language=' . request()->input('language')}}" class="btn btn-primary btn-back">{{clean( trans('niva-backend.back_videos') , array('Attr.EnableID' => true))}}</a>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="slug-container"><input type="text" name="video" class="form-control" placeholder=""></div>
{{--                                                <div class="slug-container"><span>{{URL::to('/')}}/</span><input type="text" name="video" class="form-control" placeholder=""></div>--}}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="body" rows="5"></textarea>
                                    </div>
