...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::get('/video-details/{id}'   , [HomeController::class, 'videoDetails'])->name('video-details');
    Route::post('/add-order', [HomeController::class, 'addOrder'])->name('addOrder');
...
Route::middleware(['admin'])->group(function () {
    ...
    Route::delete('/delete/video', [VideoController::class, 'delete_video'])->name('delete.video');

    //Orders
    Route::resource('admin/order', OrderController::class);
    Route::delete('/delete/order', [OrderController::class, 'delete_order'])->name('delete.order');

    //Admin Orders Status
    Route::post('admin/order-accepted/{id}',[OrderController::class, 'approve'])->name('approve');
    Route::post('admin/order-rejected/{id}',[OrderController::class, 'reject'])->name('reject');
